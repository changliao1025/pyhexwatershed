...
def merge_stream_edge_to_stream_segment(sFilename_stream_edge_geojson_in,
    ...
    aFlowline_edge_basin_conceptual, pProjection_geojson = read_flowline_geojson(sFilename_stream_edge_geojson_in)
    ...
    pRivergraph = pyrivergraph(aFlowline_edge_basin_conceptual, pVertex_outlet_in)
